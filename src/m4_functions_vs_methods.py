...
def try_methods_and_functions():
    ...
    new_turtle.pen = rg.Pen('blue',5)
    new_turtle.backward(150)
    new_turtle.speed = 1
    draw_many_squares(new_turtle, 2, 100, 30)
    new_turtle.speed = 5
    new_turtle.pen = rg.Pen('red', 5)
    draw_many_squares(new_turtle, 10, 50, 15)
    new_turtle.speed = 100
    new_turtle.pen = rg.Pen('red', 35)
    draw_many_squares(new_turtle, 8, 300, 60)
    new_turtle.pen = rg.Pen('black', 3)
    new_turtle.backward(200)
    new_turtle.draw_circle(25)
    new_turtle.draw_square(50)
# -----------------------------------------------------------------------------
